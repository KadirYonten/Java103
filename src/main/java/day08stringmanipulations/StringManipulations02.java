...
public class StringManipulations02 {
    ...
    public static void main(String[] args) {
        ...
        int num = str.replace(" ", "").length();    // (" ") != ("")  ayni sey degildir.. bosluk yerine hiclik koyduk.
        ...
        String yeniS = s.replace("a", "A");                         // replace(); ayni karakterin yada parcanin tamamini dizide degistirir.
        ...
        //Example 4: Bir String'deki tüm sayilari "*" a ceviriniz.            // replaceAll(); ayni türdeki, farkli karakterlerin tamamini dizide degistsirir.
        //           "AC202117004" ==> AC*********
        ...
        /*
            ...
            Bir grup data'yi ifade eden kod'lara "Regex" denir. "Regex" Regular Expressions in kisaltilmis halidir.

            1)Tum rakamlar ==> [0-9]                                    \\ d --> Tüm rakamlar (digit)
            2)Tum kucuk harfler ==> [a-z]
            3)Tum buyuk harfler ==> [A-Z]
            4)Tum harfler ==> [a-zA-Z]
            5)Sesli harfler ==> [aeiouAEIOU]
            6)Space ==> [ ]                                            \\ s --> Tüm bosluklar
            7)Tum rakamlar ve tum harfler ==> [0-9a-zA-Z]              \\ w --> Tüm kücük ,büyük harfler ve rakamlar
            8)Tum noktalama isaretleri ==> \\p{Punct}

           ^ HARIC Ifadeler
            1)Rakamlar haric tum karakterler ==> [^0-9]                 \\ D --> Tüm rakamlar haric
            ...
            5)Space haric ==> [^ ]                                      \\ S --> Space haricler
            6)Büyük, kücük harfler ve Rakamlar haricindeki              \\ W --> Tüm noktalama isaretleri haric


            \t --> Tab bir bosluk yazdirmak icin
            \n --> Next yeni bir satira gecmek icin
            \b --> Back bir önceki harfi silmek icin
            \\ --> \ Bir tane back slash yazdirmak icin ilk \´i String te islem yapabilmek icin
        ...
        */
        ...
        //Example 7: Bir String'deki noktalama isaretlerinin sayisini gösteren kodu yaziniz.
        ...
        String v = "Kalex";
        boolean baslangic = v.startsWith("Al");                         // startWith(); method
        boolean bitis = v.endsWith("x");                                // endWith(); method
        ...
        // String ad = "Aleeeex";
        String ad = "Aleeeex";
        boolean ilkB = ad.substring(0,2).equals("Al");                       // substring();  alt dize.. Bir cümle veya kelime icinde bir parcayi almak icin..
        boolean sonB = ad.substring(ad.length()-1).equals("x");   // equals(); esitmidir.. Stringlerde aynimi diye sormak icin kullanilir..

        String son = (ilkB && sonB) ? "Harika" : "Normal";
