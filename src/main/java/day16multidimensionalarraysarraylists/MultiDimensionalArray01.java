...
public class MultiDimensionalArray01 {
    ...
    /*
        ...
        Array veya Collection var ama "index" kullanmak zorundaysaniz o zaman "for-each-loop" calismaz, calismadigi icinde
    ...
    public static void main(String[] args) {
        ...
        int arr[][] = { {2, 5, 1}, {32, 75} };
        int sum = 0;
        //{ {2, 5, 1}, {32, 75} }   bu örnek üstünden konusursak...

        for(int[] w : arr){       // for each te data type icin int[] --> int Array yazdik cünki multiArray in elemanlarida Array!!
            for(int k : w){       // bu for each te k isimli
                sum = sum + k;
            }
        }
