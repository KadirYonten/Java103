...
public class MethodCreation {
    ...
    public static void main(String[] args) {
        ...
        //Ekrana bir sey yazdirmak icin iki tane kod var     i)System.out.println() ==> Satirbasi yapar yani sonraki satira gecer, println --> print line
    ...
    public static double ilkIkiyiToplaUcuncuIleCarp(double a, double b, double c) {  return (a + b) * c; }     // Kodu tek satirda da yazabiliriz..
}
