...
public class IfStatement03 {
        ...
        /*
            Iki tane String'in birbirine esit olup olmadigini anlamak icin " == " degil, " equals() " methodu kullanmaliyiz.
            Iki tane String'in birbirine esit olup olmadigini kontrol etmek icin iki tane method kullanilabilir.

                i) equals() ==> Buyuk harf ve kucuk harfe duyarlidir.. "A" ile "a" farklidir!

                ii) equalsIgnoreCase() ==> Buyuk harf kucuk harfi önemsemez. "A" ile "a" aynidir.
        */
    ...
    public static void main(String[] args) {
        ...
        if (haftaSonu) {
            ...
            System.out.println(" Gecerli bir gün ismi girin...");
        }
