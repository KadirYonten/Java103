...
public class TreeMap01 {
    ...
    /*
        1)TreeMap'ler entrySet'leri key'lere gore "natural order" da (dogal siralama --> kücükten büyüge yada alfabetik) siralar.
    ...
    public static void main(String[] args) {
        ...
        NavigableMap<String, Double> map2 = salaries.tailMap("Kevin Bridgeman", false);// inclusive-->false dedimiz icin..
        ...
        //lowerEntry("Paris Hilton") Paris Hilton'dan bir oncesini verir, Paris Hilton olmasa da sanki varmis gibi (sirasina gore) davranir
        ...
        Map.Entry<String, Double>  map8 = salaries.ceilingEntry("Mary Star");//ceiling --> tavan,cati demektir
        ...
        Map.Entry<String, Double>  map10 = salaries.floorEntry("Mary Star");// floor --> taban demektir bir öncekini verir
