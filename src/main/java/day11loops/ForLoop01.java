...
public class ForLoop01 {
    ...
    public static void main(String[] args) {
        ...
        String str = "Adem Keskin";

        //Concatenation yapacajsaniz "" (bos  string ) kullanin... Concatination = birlestirme...

        String ters = "";       // String variable
        // ne bos string (stringin etkisiz elemanini) yazdik...
