...
public class HashMap01 {
    ...
    public static void main(String[] args) {
        ...
        //Belli bir key'e ait value nasil alinir?   get() metodu ile belirli bir degeri alabiliriz.
        ...
        for(Integer w : ages){
            if(w!=null){
                sum = sum + w;      //sum += w ;seklindede yazabilirdik.
                counter++;
            }
        }
        ...
        //remove("Ajda", 76) key'si Ajda ve value'su 76 olan EntrySet i siler ve size boolean return eder.  remove () Entry set i silmek icin
        ...
        //Key varsa value'u ver, key yoksa sizin istediginiz degeri verir  getOrDefault ()
