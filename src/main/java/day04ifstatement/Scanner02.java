...
public class Scanner02 {
    ...
    public static void main(String[] args) {
        ...
        char soyIsminIlkHarfi = tamIsim.split(" ")[1].charAt(0);       // split (); metodu ile bosluktan parcalayip ikinci parcanin ilk harfini aldik
        System.out.println(soyIsminIlkHarfi);                                // split (" ") ---> Ali Can ---> Ali(0)   Can(1).charAt(0);
      }
}