...
public class Exceptions03 {
    ...
    public static void main(String[] args) throws IllegalGradeException {
        ...
        printGrades(60);    // Notlari yazdir, dersten aldigi notu yazdiran code

        checkNameFormat("Ali");

    }

    // Example: Ogrenci notlarini yazdiran bir method olusturunuz.
    ...
    // Example: Verilen ismin ilk harfinin buyuk harf olmamasi durumunda Exception atan method yaziniz
