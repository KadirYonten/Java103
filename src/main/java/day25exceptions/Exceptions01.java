...
public class Exceptions01 {
    ...
    /*
      ...
      2) Exception lar ile calismanin iki yolu vardir
            a) try-catch block kullanma ve exception olussa bile code´u calısmaya devam ettirme..
            b) throw exception kullanarak code´un calismasini durdurma!!(mesela yazdigimiz kod geregi bir dosya uzerinden okuma yapmamız
            gerekiyor ise bu dosyamız eger silinmis ise java dosyayi bulamaz ve uygulanın devam etmemesi gerekir)
